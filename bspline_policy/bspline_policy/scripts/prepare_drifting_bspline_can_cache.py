"""Prepare Can replay and B-spline caches without creating a simulator."""
...
def main() -> None:
    ...
    print(f"Can B-spline train samples: {len(dataset)}")
    print(f"Can B-spline validation samples: {len(validation_dataset)}")
    print(f"Can B-spline action shape: {action_shape}")
